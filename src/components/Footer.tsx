      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/tools" className="text-gray-400 hover:text-white text-sm">Tools</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/desktop" className="text-gray-400 hover:text-white text-sm">FileFlex Desktop</Link></li>
              <li><Link to="/mobile" className="text-gray-400 hover:text-white text-sm">FileFlex Mobile</Link></li>
              <li><Link to="/api" className="text-gray-400 hover:text-white text-sm">FileFlex API</Link></li>
              <li><Link to="/img" className="text-gray-400 hover:text-white text-sm">FileFlex IMG</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/education" className="text-gray-400 hover:text-white text-sm">Education</Link></li>
            </ul>
          </div>
          ...
          {/* App Stores */}
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-wider mb-4">Get the App</h3>
            <div className="space-y-3">
              <a href="#" className="block">
                <div className="bg-black border border-gray-700 rounded-lg px-3 py-2 flex items-center space-x-2 hover:border-gray-500">
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row items-center justify-between">
          <div className="flex items-center space-x-2 mb-4 md:mb-0">
            <LogoIcon size={24} />
            <span className="text-lg font-bold">FileFlex</span>
          </div>
          ...
          <div className="mt-4 md:mt-0 text-sm text-gray-400">
            © FileFlex {new Date().getFullYear()} ® - Your PDF Editor
          </div>
        </div>
      </div>
    </footer>
